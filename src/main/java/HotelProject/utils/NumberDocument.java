...
public class NumberDocument extends PlainDocument {
  ...
  public NumberDocument(int maxLen, int qtdDec)
  {
    this(maxLen, qtdDec, '.', ',');
  }
  ...
  public NumberDocument(int maxLen, int qtdDec, char mil, char dec){
    super();
  ...
  public void insertString(int offs, String str, AttributeSet attrSet) throws BadLocationException {
        ...
        ||  (this.iMaxLength <= 0))
    {
      ...
      StringBuilder s = new StringBuilder(texto + str.replace(sDec, "").replace(sMil, ""));
